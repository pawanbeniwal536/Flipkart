                ...
                <div className="login-footer-child-container  ">
                    <div className="login-footer-items flex pl-12 pr-12 ">
                        <div className="login-footer-left-items flex w-full justify-between">
                            ...
                            <div className="login-footer-consumer text-gray-500 font-bold">
                                CONSUMER POLICY
                                <div className="login-footer-child-items pt-2">
                                    <p>Cancellation & Returns </p>
                                    <p>Terms of Use</p>
                            ...
                            <div className="login-footer-mail-social">
                            ...
                            <div className="login-footer-registered text-gray-500 font-bold ">
                        ...
                        <div className="login-below-items flex justify-evenly pt-6 pb-6">
